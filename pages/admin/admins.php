...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a href="#" class="navbar-brand"> SEI</a>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a href="admins" class="nav-link active">Manage Admins</a>
        </li>
        <li class="nav-item">
  ...
  <div class="row">
    <div class="offset-lg-1 col-lg-10" style="min-height:400px;">
      <?php
       ...
       echo SuccessMessage();
       ?>
      <form class="" action="admins" method="post">
      ...
      <tbody>
        <tr>
          ...
          <td> <a href="deleteadmin?id=<?php echo $AdminId;?>" class="btn btn-danger">Delete</a>  </td>
