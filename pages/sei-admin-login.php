            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0" >
                ...
                <div class="nav-item fw-bold dropdown">
                    ...
                    <div class="dropdown-menu fade-up custom-menu">
                        <a href="sei-admin-login?lang=en" class="dropdown-item fw-bold">EN<img src="../img/us.png" width="35" height="26"></a>
                        <a href="sei-admin-login?lang=th" class="dropdown-item fw-bold">TH<img src="../img/thai.png" width="35" height="26"></a>
                        <a href="sei-admin-login?lang=jp" class="dropdown-item fw-bold">JP<img src="../img/ja.png" width="35" height="26"></a>
                    </div>
        ...
        <div class="offset-sm-3 col-sm-6" style="min-height:500px;">
          ...
          <div class="card bg-secondary text-light">
            <div class="card-header">
              <h4 class=" fw-bold text-uppercase text-primary" style="margin-top: 10px; letter-spacing: 0.2em; font-weight: bolder;text-align: center;">Welcome Back!</h4>
              </div>
              <div class="card-body bg-dark">
              <form class="" action="sei-admin-login" method="post">
                ...
                <input type="submit" name="Submit" class="btn btn-primary py-3 px-5 fw-bold animated slideInDown" value="Login">
              </form>
