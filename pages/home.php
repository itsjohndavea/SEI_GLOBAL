 ...
 <nav class="navbar navbar-expand-lg bg-white navbar-light  sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse" style="margin-right: 50px;">
            <div class="navbar-nav ms-auto p-4 p-lg-0" >
                <a href=""></a>
                <a href="./home" class="nav-item nav-link fw-bold active"><?= __('Home')?></a>
                ...
                <div class="nav-item fw-bold dropdown">
                    ...
                    <div class="dropdown-menu fade-up custom-menu">
                        <a href="home?lang=en" class="dropdown-item fw-bold">EN<img src="../img/us.png" width="35" height="26"></a>
                        <a href="home?lang=th" class="dropdown-item fw-bold">TH<img src="../img/thai.png" width="35" height="26"></a>
                        <a href="home?lang=jp" class="dropdown-item fw-bold">JP<img src="../img/ja.png" width="35" height="26"></a>
                    </div>
                </div>
    ...
    <div class="carousel-item">
        ...
        <div class="carousel-caption d-flex align-items-center">
          <div  class="container">
            <div class="row align-items-center justify-content-center justify-content-lg-start">
              <div class="col-10 col-lg-7 text-center text-lg-start">
                <p class="h5 fw-bold section-text animated slideInDown text-uppercase custom-title" >Expert Car Protection</p>
                ...
                <a href="./sei" class="btn btn-secondary py-3 px-5 animated slideInDown">Learn More<i class="fa fa-arrow-right ms-3"></i></a>
              </div>
            </div>
          </div>
    </div>
    ...
    <div class="carousel-item">
        ...
        <div class="carousel-caption d-flex align-items-center">
          <div  class="container">
            <div class="row align-items-center justify-content-center justify-content-lg-start">
              <div class="col-10 col-lg-7 text-center text-lg-start">
                  <p class="fw-bold section-text animated slideInDown text-uppercase custom-title">Confidently coated premium cars</p>
                  <div class="col-lg-8 d-none d-lg-flex animated zoomIn">
          ...
          <div class="row">
              ...
              <div class="card" style="border-radius: 15px;">
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center pb-2 mb-1">
                    <a href="./3001" class="h4 animated slideInDown fw-bold" style="text-decoration: none;"><?= __('More details')?><i class="fa fa-arrow-right ms-3"></i></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-12 col-lg-4 mb-4 mb-lg-2">
              <div class="card" style="border-radius: 15px;">
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center pb-2 mb-1">
                    <a href="./3031" class="h4 animated slideInDown fw-bold" style="text-decoration: none;"><?= __('More details')?><i class="fa fa-arrow-right ms-3"></i></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-12 col-lg-4 mb-4 mb-lg-2">
              <div class="card" style="border-radius: 15px;">
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center pb-2 mb-1">
                    <a href="./T21" class="h4 animated slideInDown fw-bold" style="text-decoration: none;"><?= __('More details')?><i class="fa fa-arrow-right ms-3"></i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <a href="./sei" class="btn btn-primary py-3 px-5  fw-bold"><?= __('Read More')?><i class="fa fa-arrow-right ms-3"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row flex-row col-sm-12 ml-2">
              ...
              <div class="col-lg-4">
                ...
                <a href="./fullpost?id=<?php echo htmlentities($PostId) ; ?>"><img src="./uploads/<?php echo htmlentities($Image); ?>" style="height: 250px;" class="d-block card-img-top" alt=""></a>
                <a style="text-decoration:none;" href="./fullpost?id=<?php echo htmlentities($PostId) ; ?>"> <?php
              ...
              <p class="card-text" style="height: 90px;">
                ...
                <?php if (strlen($PostDescription)>120) { $PostDescription = substr($PostDescription,0,120)."...";} echo htmlentities($PostDescription); ?></p>
              <a href="./fullpost?id=<?php echo $PostId; ?>" style="float:right; text-decoration:none;">
